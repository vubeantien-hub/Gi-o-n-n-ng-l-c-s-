...
<div class="main-header">
    ...
    <p>Tác giả: Vũ Thị Bé - Trường Tiểu học Hùng An- ĐT: 0827240677</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vũ Thị Bé - Trường Tiểu học Hùng An - ĐT: 0827240677</div>", unsafe_allow_html=True)
